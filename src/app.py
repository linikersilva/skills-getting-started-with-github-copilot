...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team soccer skills and compete in interscholastic matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, improvise, and prepare performances for school events",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "jack@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research topics, practice public speaking, and compete in debate tournaments",
